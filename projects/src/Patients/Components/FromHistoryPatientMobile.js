...
export default class FromHisProfilePatient extends React.Component {
    ...
    render() {
        return (
                    ...
                    <Segment >
                        <List divided relaxed>
                            <List.Item>
                                ...
                                <p style={{fontSize:'1.3em'}}><Icon name='history' />Medical History</p>
                            </List.Item>
                        </List>
                        ...
                        <Container>
                            <Grid>
                                <Grid.Column >
                                    <Scrollbars autoHide style={{ height: '670px' }}>
                                        <List divided relaxed>
                                            <List.Item onClick={() => { this.props.setField("statusShowHistory", false) }}>
                                                <List.Content>
                                                    <List.Content floated='right'>
                                                        <List.Description as='a' >
                                                            <Icon name='calendar alternate outline' size='small' />
            ...
            //     <h3><Icon name='arrow left' style={{ marginLeft: 15 }}/> Medical Record History</h3>
            //             <Divider />
