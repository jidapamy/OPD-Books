        ...
        return (
            ...
            >
                ...
                <Statistic inverted size='mini'>
                        <Statistic.Label style={{ fontSize: '1.1em' }} >{this.props.patient.nameTitle} {this.props.patient.firstname} {this.props.patient.lastname}</Statistic.Label>
                    <Statistic style={{ fontSize: '1.1em' }} >Citizen ID : {this.props.patient.citizenId}</Statistic>
                </Statistic>
            </BGMobiles>
