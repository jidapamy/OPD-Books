...
class SidebarBottomOverlay extends Component {
  ...
  getPatient = qrCode => {
    ...
    const InfoPatientPart1 = contract.getInfoPatientPart2(qrCode, defaultAccount);
    const InfoPatientPart1 = contract.getInfoPatientPart3(qrCode, defaultAccount);
    const InfoPatientPart1 = contract.getInfoPatientPart4(qrCode, defaultAccount);
  ...
  render() {
    ...
    return (
      <div>
        <Navbar role="emp" show={this.show} />
        ...
        <Container>
          ...
          <Segment>
            ...
            <Grid columns={4} relaxed>
              <Grid.Column>
                <Segment basic>
                  <Header size="small" as="h4" color="teal">
                    {" "}
                    Hospitalnumber
                  </Header>
                  {this.state.hospitalnumber}
