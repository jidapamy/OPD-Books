...
contract PatientProfile {
    ...
    mapping ( string => PatientAllergy ) patientAllergies;
    mapping ( string => PatientEmail ) patientEmails;
    
    
    // --------DetailPatient---------//
    
    function getDetailPatient(string _citizenId) view public returns(bytes32 , bytes32 , bytes32 , bytes32 , bytes32 ,bytes32 ,bytes32) {
         return ( 
    ...
    function Login(string _citizenId,bytes32 _password) view public returns(bool) {
        bool statusLogin;
    ...
    function ForgetPassword(string _citizenId,bytes32 _email) view public returns(bool) {
    ...
    function checkDuplicateCitizenId(string _citizenId) view public returns(bool) {
    ...
    function checkDuplicateEmail( string _emails,bytes32 _email) view public returns(bool) {
        bool statusEmail;
        
        if(keccak256(patientEmails[_emails].patientsEmail)==keccak256(_email) ){
            statusEmail=true;
        }
        return statusEmail;
    }
    ...
    function setEmail( bytes32  _email, string  _emails )  public {
                PatientEmail storage patientEmail = patientEmails[_emails];
                patientEmail.patientsEmail= _email;
    }
    // --------getInfoPatient---------//
   
    function setInfoPatientPart1( string  _citizenId, bytes32  _registerDate, bytes32  _hospitalnumber, bytes32 _password) public {
    ...
    function setInfoPatientPart2( string  _citizenId, bytes32  _dob, bytes32  _titlename, bytes32  _firstname, bytes32  _lastname, bytes32  _gender )  public {
                InfoPatient storage infoPatient = infoPatients[_citizenId];
    ...
    function setInfoPatientPart3( string  _citizenId, bytes32  _congenitaldisease, bytes32  _bloodgroup, bytes32  _religion, bytes32  _nationality, bytes32  _country )  public {
                InfoPatient storage infoPatient = infoPatients[_citizenId];
    ...
    function setInfoPatientPart4( string  _citizenId, bytes32  _status, bytes32  _occupartion, bytes32  _homephonenumber, bytes32  _mobilenumber , bytes32  _email )  public {
                InfoPatient storage infoPatient = infoPatients[_citizenId];
    ...
    // --------getInfoPatient---------//
    function getInfoPatientPart1(string _citizenId) view public  returns (bytes32 , bytes32 , string , bytes32  ) {
        return ( 
    ...
    function getInfoPatientPart2(string _citizenId) view public  returns (bytes32 , bytes32 , bytes32 , bytes32 , bytes32  ) {
        return ( 
                infoPatients[_citizenId].infoPart2.dob,
    ...
    function getInfoPatientPart3(string _citizenId) view public  returns (bytes32 , bytes32 , bytes32 , bytes32 , bytes32 ) {
        return ( 
    ...
    function getInfoPatientPart4(string _citizenId) view public  returns (bytes32 , bytes32 , bytes32 , bytes32 , bytes32 ) {
        return ( 
      ...
      // --------setAddressPatient---------//
    function setAddressPatient( string  _citizenId, bytes32  _typeofHouse, string  _patienaddress, bytes32  _province, bytes32  _district, bytes32  _subDistrict, bytes32 _zipcode )  public {
    ...
    // --------getAddressPatient---------//
    function getAddressPatient(string _citizenId)view public  returns (bytes32 , string , bytes32 , bytes32, bytes32 , bytes32 ) {
        return ( 
    ...
    // --------setAddressPatient---------//
    function setEmergencyContactPart1( string  _citizenId, bytes32  _emerTitle, bytes32  _emerFirstname, bytes32 _emerLastname, bytes32  _emerRelationship, bytes32  _emerHomePhonenumber, bytes32  _emerMobileNumber ) public {
    ...
    function setEmergencyContactPart2( string  _citizenId, bytes32  _emerTypeofHouse, string  _emerAddress, bytes32  _emerProvince, bytes32  _emerDistrict, bytes32  _emerSubDistrict, bytes32 _emerZipcode )  public {
                EmergencyContact storage emergencyContact = emergencyContacts[_citizenId];
    ...
    function getEmergencyContactPart1(string _citizenId) view public  returns (bytes32 , bytes32 , bytes32 , bytes32, bytes32 , bytes32 ) {
        return ( 
    ...
    function getEmergencyContactPart2(string _citizenId) view public  returns (bytes32 , string , bytes32 , bytes32, bytes32 , bytes32 ) {
        return ( 
    ...
    // --------setPatientParent---------//
   function setPatientParent( string  _citizenId, bytes32  _fatherFirstname, bytes32  _fatherLastname, bytes32  _motherFirstname, bytes32  _motherLastname )  public {
    ...
    // --------setPatientParent---------//
    function getPatientParent(string _citizenId)view public  returns (bytes32 , bytes32 , bytes32 , bytes32 ) {
        return ( 
    ...
    function setPatientAllergy( string  _citizenId, bytes32  _allergy, bytes32  _privilege )  public {
   ...
   function getPatientAllergy(string _citizenId)view public  returns (bytes32 , bytes32  ) {
        return ( 
