    ...
    <div>
        <Segment>
            ...
            <Form.Group>
                    ...
                    <Form.Field control={Select} label='จังหวัด (Province)' options={provinces} placeholder='เลือกจังหวัด' width={6} onClick={() => preparedData('a')} value={emerProvince} onChange={(e, value) => changeProvince('emerProvince', value)} />
            </Form.Group>
            <Form.Group>
                    <Form.Field control={Select} label='เขต/อำเภอ (District)' options={amphurs} placeholder='เลือกเขต/อำเภอ' width={6} onClick={() => preparedData('d')} value={emerDistrict} onChange={(e, value) => changeAmphur('emerDistrict', value)} />
