...
const EmergencyContact = (props) => {
    ...
    return (
        <div>
            <Segment>
                <Label as='a' color='teal' ribbon><h4 style={{ fontFamily: 'Kanit' }}>กรณีฉุกเฉินติดต่อ (In case of emergency contact)</h4></Label>
                <br></br><br></br>
            ...
            <Form.Group>
                    <Form.Input 
                    label='เกี่ยวข้องเป็น (Relationship Related)' 
